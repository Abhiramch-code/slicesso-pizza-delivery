      ...
      <section className="relative pt-32 pb-20 px-8 md:px-16 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 space-y-8 text-center lg:text-left">
          ...
          <p className="text-lg text-gray-500 max-w-xl mx-auto lg:mx-0">
            The ultimate Slices platform designed for high-velocity kitchens. 
            Real-time ingredient tracking, dynamic wizards, and automated delivery logistics.
          </p>
          <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-4">
            <Link to="/pizza-builder" className="px-8 py-4 bg-red-600 text-white rounded-xl font-bold shadow-xl shadow-red-600/30 hover:bg-red-700 transition-all active:scale-95">
        ...
        <div className="flex-1 relative">
          ...
          <img 
            ...
            alt="Hero Pizza" 
            className="relative w-full h-auto drop-shadow-[0_35px_35px_rgba(0,0,0,0.15)]"
            onError={(e) => { e.target.onerror = null; e.target.src = 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=800&auto=format&fit=crop'; }}
          />
        </div>
      </section>
      ...
      <section className="py-24 px-8 md:px-16 bg-white">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Featured Card */}
            <div className="md:col-span-2 relative group overflow-hidden rounded-3xl aspect-video">
              <img 
                src="/images/featured-pizza.jpg" 
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" 
                alt="Mediterranean Tech"
                onError={(e) => { e.target.onerror = null; e.target.src = 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=1200&auto=format&fit=crop'; }}
              />
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/20 to-black/80 p-12 flex flex-col justify-end">
                ...
                <Link to="/pizza-builder" className="flex items-center gap-2 text-white font-bold group">
            ...
            <div className="space-y-8">
              {[
                { title: 'Classic API Margherita', seed: 'margherita', desc: 'Pure, simple, reliable.' },
                { title: 'Hot-Reload Buffalo', seed: 'buffalo', desc: 'For those who like a little kick.' }
              ].map((item) => (
                <div key={item.title} className="relative group overflow-hidden rounded-3xl aspect-4/3">
                  <img 
                    src={`/images/${item.seed}.jpg`}
                    className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" 
                    alt={item.title}
                    onError={(e) => { e.target.onerror = null; e.target.src = `https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=600&auto=format&fit=crop`; }}
                  />
